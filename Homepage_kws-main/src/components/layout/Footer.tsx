...
const Footer: React.FC = () => {
  return (
    ...
    <footer className="z-10 w-full  text-white">
     
        {/* Footer content with three columns */}
        <div className="py-10 lg:py-10 px-5 xl:px-10 mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center mt-4">
            <a href="#" className="text-[28px] font-bold flex items-center hover:text-[#913BFF] transition-colors duration-300">
              Let's Chat
        ...
        <div className="flex flex-col md:items-center">
          <h3 className="text-[17px] font-medium mb-4 md:mb-6">
            <a href="#" className="hover:text-[#913BFF] transition-colors duration-300">About Us</a>
          </h3>
          <h3 className="text-[17px] font-medium mb-4 md:mb-6">
            <a href="#" className="hover:text-[#913BFF] transition-colors duration-300">Contact Us</a>
          </h3>
          <h3 className="text-[17px] font-medium mb-4 md:mb-6">
            <a href="#" className="hover:text-[#913BFF] transition-colors duration-300">Services</a>
          </h3>
          <h3 className="text-[17px] font-medium">
            <a href="#" className="hover:text-[#913BFF] transition-colors duration-300">Join Team</a>
          </h3>
        </div>
